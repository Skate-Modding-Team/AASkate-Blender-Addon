...
void unswizzle_wii_textures_and_write_to_DDS(std::string filename, const std::vector<uint8_t>& data, int width, int height, int mipMapLevels, uint32_t pixelFormat, uint32_t type, uint8_t flags);
